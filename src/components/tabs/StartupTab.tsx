...
export const StartupTab = () => {
  ...
  const [components, setComponents] = useState<SCADAComponent[]>([
    ...
    { id: "adas-5", name: "ADAS-5", state: "OFF", x: 480, y: 500, subsystem: "adas" },
    { id: "adas-6", name: "ADAS-6", state: "OFF", x: 560, y: 500, subsystem: "adas" },
    ...
    { id: "ooqs-5", name: "OOQS-5", state: "OFF", x: 480, y: 600, subsystem: "ooqs" },
    { id: "ooqs-6", name: "OOQS-6", state: "OFF", x: 560, y: 600, subsystem: "ooqs" },
