...
export const StartupTab = () => {
  ...
  const [components, setComponents] = useState<SCADAComponent[]>([
    ...
    { id: "tcs-1", name: "TCS-1", state: "OFF", x: 100, y: 400, subsystem: "tcs" },
    { id: "tcs-2", name: "TCS-2", state: "OFF", x: 200, y: 400, subsystem: "tcs" },
    { id: "tcs-3", name: "TCS-3", state: "OFF", x: 300, y: 400, subsystem: "tcs" },
    { id: "tcs-4", name: "TCS-4", state: "OFF", x: 400, y: 400, subsystem: "tcs" },
    { id: "tcs-5", name: "TCS-5", state: "OFF", x: 500, y: 400, subsystem: "tcs" },
    { id: "tcs-6", name: "TCS-6", state: "OFF", x: 600, y: 400, subsystem: "tcs" },
    { id: "tcs-7", name: "TCS-7", state: "OFF", x: 700, y: 400, subsystem: "tcs" },
    { id: "tcs-8", name: "TCS-8", state: "OFF", x: 800, y: 400, subsystem: "tcs" },
    { id: "tcs-9", name: "TCS-9", state: "OFF", x: 900, y: 400, subsystem: "tcs" },

    // ADAS components (9)
    { id: "adas-1", name: "ADAS-1", state: "OFF", x: 100, y: 500, subsystem: "adas" },
    { id: "adas-2", name: "ADAS-2", state: "OFF", x: 200, y: 500, subsystem: "adas" },
    { id: "adas-3", name: "ADAS-3", state: "OFF", x: 300, y: 500, subsystem: "adas" },
    { id: "adas-4", name: "ADAS-4", state: "OFF", x: 400, y: 500, subsystem: "adas" },
    { id: "adas-5", name: "ADAS-5", state: "OFF", x: 500, y: 500, subsystem: "adas" },
    { id: "adas-6", name: "ADAS-6", state: "OFF", x: 600, y: 500, subsystem: "adas" },
    { id: "adas-7", name: "ADAS-7", state: "OFF", x: 700, y: 500, subsystem: "adas" },
    { id: "adas-8", name: "ADAS-8", state: "OFF", x: 800, y: 500, subsystem: "adas" },
    { id: "adas-9", name: "ADAS-9", state: "OFF", x: 900, y: 500, subsystem: "adas" },

    // OOQS components (9)
    { id: "ooqs-1", name: "OOQS-1", state: "OFF", x: 100, y: 600, subsystem: "ooqs" },
    { id: "ooqs-2", name: "OOQS-2", state: "OFF", x: 200, y: 600, subsystem: "ooqs" },
    { id: "ooqs-3", name: "OOQS-3", state: "OFF", x: 300, y: 600, subsystem: "ooqs" },
    { id: "ooqs-4", name: "OOQS-4", state: "OFF", x: 400, y: 600, subsystem: "ooqs" },
    { id: "ooqs-5", name: "OOQS-5", state: "OFF", x: 500, y: 600, subsystem: "ooqs" },
    { id: "ooqs-6", name: "OOQS-6", state: "OFF", x: 600, y: 600, subsystem: "ooqs" },
    { id: "ooqs-7", name: "OOQS-7", state: "OFF", x: 700, y: 600, subsystem: "ooqs" },
    { id: "ooqs-8", name: "OOQS-8", state: "OFF", x: 800, y: 600, subsystem: "ooqs" },
    { id: "ooqs-9", name: "OOQS-9", state: "OFF", x: 900, y: 600, subsystem: "ooqs" },
  ]);
